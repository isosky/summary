<template>
  <div id="app">
    <el-col :span="6">
      ...
      <el-row :span="6">
        <el-col :span="8">
          <el-input v-model="subjectname" style="width: 150px" placeholder="请输入分类名称"></el-input>
        </el-col>
        <el-col :span="8">
          <el-input v-model="subjectvalue" style="width: 150px" placeholder="请输入分类类型"></el-input></el-col>
        <el-col :span="8">
          <el-button @click="addtype">添加分类</el-button></el-col></el-row>

      <el-row :span="6"><el-table :data="subjectdata" style="width: 100%">
      ...
      <el-row :span="6"><el-table :data="nodirdata" style="width: 100%">
          ...
          <el-table-column label="操作" width="170">
            <template slot-scope="scope">
              <el-button @click="showdirupdatepanel(scope.row)" type="text" size="small">修改</el-button>
            </template>
          </el-table-column>
        </el-table>
      </el-row>
    ...
    <el-col :span="6">
      <el-table :data="typedata" style="width: 100%" height="700">
        ...
        <el-table-column label="操作" width="170">
          <template slot-scope="scope">
            <el-button @click="showupdatepanel(scope.row)" type="text" size="small">修改</el-button>
          </template>
        </el-table-column>
      </el-table>
    </el-col>
    <el-col :span="12">
      <el-row :span="5">
        <el-col :span="4">
          <el-input clearable v-model="city_name" style="width: 150px" placeholder="城市名称"></el-input>
        </el-col>
        <el-col :span="4">
          <el-input clearable v-model="city_lon" style="width: 150px" placeholder="经度"></el-input></el-col>
        <el-col :span="4">
          <el-input clearable v-model="city_lat" style="width: 150px" placeholder="纬度"></el-input>
        </el-col>
        <el-col :span="3">
    ...
    <el-dialog @close="dialogpVisible = false" title="提示" :visible.sync="dialogpVisible" width="30%">
      <el-input v-model="new_sub_type" style="width: 200px" placeholder="请输入新类型"></el-input>

      <el-button type="primary" @click="commitnewsubtype">确 定</el-button>
    </el-dialog>
    <el-dialog @close="dialogdirVisible = false" title="提示" :visible.sync="dialogdirVisible" width="30%">
      <!-- <el-input
      ...
      <el-select v-model="new_dir_type" placeholder="请选择">
        <el-option v-for="item in diroptions" :key="item.value" :label="item.label" :value="item.value">
        </el-option>
      </el-select>
