<template>
  ...
  <div id="app">
    <el-row :gutter="5">
      ...
      <el-col :span="11">
        ...
        <el-row :gutter="5">
          ...
          <el-col :span="5">
            <el-checkbox-button v-model="isstime" @change="setdate"
              >查添加日期</el-checkbox-button
            >
    ...
    <!-- 更新 -->
    <el-dialog
      @close="dialogpersonVisible = false"
      title="添加人员"
      :visible="dialogpersonVisible"
      width="40%"
    >
      <div>
        <el-checkbox-group v-model="personrecommendselected">
          <el-checkbox
            v-for="t in personrecommend"
            :key="t.id"
            :label="t.label"
            @change="addrecommendperson(t.id)"
          ></el-checkbox>
        </el-checkbox-group>
      </div>
      ...
      <el-transfer
        ...
        :data="pppdata"
        filterable
        :filter-method="personfilterMethod"
        filter-placeholder="请输入拼音首字母"
        :titles="['所有人', '关联人']"
      ></el-transfer>
        ...
        <el-main>
          <el-form ref="form" :model="finishtaskform" label-width="80px">
            ...
            <el-row>
              <el-col :span="12">
                <el-row>
                  <el-col :span="6">
                    ...
                    >
                      <el-option
                        v-for="item in dir_select_option"
                        :key="item.value"
                        :label="item.label"
                        :value="item.value"
                      ></el-option>
                  ...
                  <el-col :span="6">
                    ...
                    >
                      <el-option
                        v-for="item in dir_sub_select_option"
                        :key="item.value"
                        :label="item.label"
                        :value="item.value"
                      ></el-option>
              ...
              <el-col :span="12">
                <el-row>
                  <el-button @click="scoresth($event)" type="success" name="1"
                    >1</el-button
                  >
                  <el-button @click="scoresth($event)" type="success" name="2"
                    >2</el-button
                  >
                  <el-button @click="scoresth($event)" type="success" name="3"
                    >3</el-button
                  >
                  <el-button @click="scoresth($event)" type="success" name="4"
                    >4</el-button
                  >
                  <el-button @click="scoresth($event)" type="success" name="5"
                    >5</el-button
                  >
                  <el-button @click="scoresth($event)" type="success" name="6"
                    >6</el-button
                  >
                  <el-button @click="scoresth($event)" type="success" name="7"
                    >7</el-button
                  >
                  <el-button
                    @click="leaveclick"
                  ...
                  >
                    ...
                    >
                      <template scope="scope">
                        <el-input
                          size="small"
                          v-model="scope.row.score_activity"
                          placeholder="请输入内容"
                    ...
                    >
                      <template scope="scope">
                        <el-input
                          size="small"
                          v-model="scope.row.score_critical"
                          placeholder="请输入内容"
                          @change="handleEdit(scope.$index, scope.row)"
                        ></el-input>
...
export default {
  ...
  mounted: function () {
    ...
    this.tasksummary_chart.on("click", function (params) {
      ...
      that.task_sub_select = temp_sub_select.join("-");
      that.task_title = "";
      that.new_edate = "";
      // that.new_edate = params["data"][0];
      that.isqueryall = true;
  ...
  methods: {
    ...
    getfinishtask_data: function () {
      axios
        .post("/getfinishtask_data", { task_id: this.s_task_id })
        .then((response) => {
    ...
    diashowperson: function (event) {
      if (this.task_select != "" && this.task_sub_select != "") {
