...
<div id="app">
    <el-col :span="14" class="grid-content bg-purple-light">
        <el-row>
            <el-collapse v-model="activeName" accordion>
                <el-collapse-item :title="lastchecktime" name="1">
                    <el-row :gutter="5">
                        <el-select @change="updatelevel2option" clearable v-model="task_level1_select" style="width: 120px" placeholder="请选择">
                            <el-option v-for="item in task_level1_option" :key="item.value" :label="item.label" :value="item.value"></el-option>
                        </el-select>
                        <el-select @change="updatelevel3option" v-model="task_level2_select" filterable clearable allow-create style="width: 120px" placeholder="请选择">
                            <el-option v-for="item in task_level2_option" :key="item.value" :label="item.label" :value="item.value"></el-option>
                        </el-select>
                        <el-select v-model="task_level3_select" filterable clearable allow-create style="width: 120px" placeholder="请选择">
                            <el-option v-for="item in task_level3_option" :key="item.value" :label="item.label" :value="item.value"></el-option>
                        </el-select>
                        <el-select v-model="schedule_type" filterable clearable allow-create style="width: 120px" placeholder="请选择">
                            <el-option v-for="item in schedule_type_option" :key="item.value" :label="item.label" :value="item.value"></el-option>
                        </el-select>
        ...
        <el-row>
            <!-- scheduledata -->
            <el-table :data="scheduledata" border height="750" style="width: 100%" @cell-click="showscheduleprocess">
                ...
                <el-table-column label="操作" width="120">
                    <template slot-scope="scope">
                        ...
                        <el-button v-if="scope.row.isabandon == '启用'" @click="forbidschedule(scope.row)" type="text" size="small">禁用</el-button>
                        <el-button v-if="scope.row.isabandon == '禁用'" @click="startschedule(scope.row)" type="text" size="small">启用</el-button>
    ...
    <el-col :span="9" :offset="1" class="grid-content bg-purple-light">
        <el-table :data="scheduletaskdata" height="800" style="width: 100%">
            <el-table-column prop="task_name" label="内容" width="180"></el-table-column>
    ...
    <el-dialog title="修改计划任务" :visible.sync="modifysVisible" width="25%">
        ...
        <el-input v-model="schedule_content" type="textarea" :autosize="{ minRows: 5 }" placeholder="请输入内容"></el-input>
